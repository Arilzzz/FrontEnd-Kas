...
async function resetPassword() {
    ...
    try {
        ...
        statusMsg.value = res.data.status || 'Password reset successfully!';
        setTimeout(() => {
    ...
    <div class="max-w-md w-full relative z-10 px-6">
      <div class="bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden border border-gray-700">
        <div class="px-8 pt-12 pb-8 text-center">
          <h2 class="text-3xl font-black text-white mb-2">Set New Password</h2>
          <p class="text-gray-400 font-medium text-sm">Create a new password for your account</p>
        </div>
