    ...
    <div class="max-w-md w-full relative z-10 px-6">
      <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl overflow-hidden border border-white/50">
        <div class="px-8 pt-12 pb-8 text-center">
          ...
          <h2 class="text-3xl font-black text-gray-900 mb-2">Create Admin</h2>
          <p class="text-gray-500 font-medium text-sm">Register a new administrator account</p>
        </div>
        ...
        <div class="px-8 pb-12">
          ...
          <div class="mt-8 text-center text-sm font-medium text-gray-500">
            <p>Already have an account? <router-link to="/admin/login" class="text-blue-600 font-bold hover:text-blue-500 transition-colors inline-block ml-1">Login Here</router-link></p>
          </div>
        </div>
      </div>
    </div>
