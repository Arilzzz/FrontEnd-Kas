    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
      ...
      <div class="lg:col-span-7 bg-gray-50 rounded-3xl p-8 border border-gray-100">
        <div class="space-y-6">
          ...
          <div>
            <label class="block text-sm font-bold text-gray-900 mb-2">Periode Pembayaran (Minggu/Bulan)</label>
            <div class="flex gap-2 mb-3">
              <button v-for="w in ['Minggu 1', 'Minggu 2', 'Minggu 3', 'Minggu 4']" :key="w" @click="selectedWeek = w" type="button"
          ...
          <div>
            <label class="block text-sm font-bold text-gray-900 mb-2">Catatan Internal (Opsional)</label>
            <textarea placeholder="Tambahkan detail transaksi ini..." rows="3" class="block w-full px-4 py-3.5 bg-gray-200/50 border-transparent rounded-xl text-gray-900 text-sm font-medium focus:bg-white focus:ring-2 focus:ring-blue-500 outline-none transition-all resize-none"></textarea>
            <p class="text-[10px] text-gray-400 mt-1">* Catatan: Field keterangan telah dihapus dari DB, sehingga catatan ini tidak akan disimpan.</p>
          </div>
